...
Ensuite, nous présentons trois approches par apprentissage profond :
...
- la troisème utilise un réseau à convolution 3D sur des séquences d'images représentant le flux optique des objets dans la vidéo
...
** Cconvolution 2D sur des images de flux optique
...
** Convolution 3D sur des images de flux optique
