...
Avec des algorithmes comme le filtre de Canny 
...
** Apprentissage profond - Deuxième approche : convolution 2D sur des images de flux optique
...
** Apprentissage profond - Troisième approche : convolution 3D sur des images de flux optique
...
- une séquence de 20 images représentant la séquence (pour le classifieur d'image à convolution 3D)
- une séquence 38 images représentant une seule image (avec 38 canaux) de flux optique par la méthode cite:DBLP:journals/corr/SimonyanZ14 (pour le classifieur de flux optique à convolution 2D)
- une image représentant la somme des flux optiques (pour le classifieur de flux optique à convolution 2D)
- une séquence 19 images représentant (pour le classifieur de flux optique à convolution 3D)
...
*** Image de flux optique : 2L canaux
...
#+ATTR_LATEX: :width 10cm
[[file:optical_flow_two_stream.png]]

*** Image de flux optique : somme des fluxs
...
L'entraînement va se faire en utilisant les instances de machines virtuelles préconfigurées pour l'apprentissage profond de Google Cloud. Le framework utilisé est TensorFlow.
