...
Dans cet article (cite:Hao_Pan_2002), Pan et. Al propose de détecter les replays dans les vidéos de sport en trouvant les frames contenant des logos. 
...
Si nous faisons l'hypothèse qu'un replay entraînera toujours un changement de plan, alors au lieu de rechercher les logos parmi tous les frames de la vidéo, nous pouvons réduire la recherche seulement aux frames qui sont entre deux plans.
...
*** Deuxième expérimentation : une séquence d'images par plan:
