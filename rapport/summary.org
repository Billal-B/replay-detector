...
Nous proposons quatres approches :
...
- dans la troisième, nous nous servons d'un réseau à convolution 3D pour classifier des séquences d'images
...
Pour conclure cette étude, nous comparons les résultats obtenus 
...
Les résultats obtenus pour la vidéo de Premier League nous laissent penser que le réseau /a commencé/ à apprendre la forme des logos dans les vidéos. 
...
Une autre piste à étudier est le /transfer learning/. Dans notre cas, nous pouvons utilisé les poids appris par les auteurs du réseau C3D sur le dataset UCF101 cite:Tran_2015.
