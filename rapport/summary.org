...
- une séquence 38 images représentant une seule image (avec 38 canaux) de flux optique par la méthode cite:DBLP:journals/corr/SimonyanZ14 (pour un classifieur de flux optique à convolution 2D)
- une image représentant la somme des flux optiques (pour un classifieur de flux optique à convolution 2D)
